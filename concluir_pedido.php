...
$primvenc		= $_POST["primvenc"];
$total 			= $pedido['valor'];
$entrada		= $_class->getEntrada($codpedido);


// alterar pedido
$altera = $_class->update($codpedido,$pedido['id_cliente'],$pedido['numero_pedido'],date('Y/m/d'),$_util->dataPhp2MySql($primvenc),$numparc,$formpag,$pedido['valor_custo'],$pedido['valor_venda'],$pedido['valor'], 2, $_util->codificaAjaxSql($obs));
