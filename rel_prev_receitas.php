...
<body class="fixed-top">
                  ...
                  <h3 class="page-title">
                     ...
                     <small>
                     	<div class="span4 invoice-block pull-right" id="impr" style="display:none">
                     		<i class="btn icon-print" onClick="document.getElementById('frm_receitas').submit()"> <b>Imprimir</b></i>
                        </div>
                     </small>
                  </h3>
               </div>
                        ...
                        <div class="widget-body form">
                            ...
                            <div class="span4"> 
                                <div class="control-group">
                                    ...
                                    <div class="input-append date date-picker" data-date="01-01-2014" data-date-format="dd/mm/yyyy" data-date-viewmode="years">
                                        <input class=" m-ctrl-medium date-picker" size="16" type="text" value="<?=date("d/m/Y")?>" name="dtini" id="dtini" 
                            ...
                            <div class="span4"> 
                                <div class="control-group">
                                    ...
                                    <div class="input-append date date-picker" data-date="01-01-2014" data-date-format="dd/mm/yyyy" data-date-viewmode="years">
                                        <input class=" m-ctrl-medium date-picker" size="16" type="text" value="<?=date("d/m/Y")?>" name="dtfim" id="dtfim" 
                                        data-date-format="dd/mm/yyyy" style="width:100px;"/>
                                        <span class="add-on"><i class="icon-calendar"></i></span>
                                    </div>
                                </div>
                            ...
                            <button type="button" class="btn btn-success" onClick="pesquisarReceitas()">PESQUISAR</button>
                            <!-- END FORM-->
                        </div>
                    </div>
                </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                        ...
                        <div class="widget-body" id="lista_receitas">
                        </div>                        
                    </div>
                </div>
			</div>
   ...
   <form name="frm_receitas" id="frm_receitas" action="impressao_receitas.php" target="impressao" method="post">
