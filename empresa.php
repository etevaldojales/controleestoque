...
<body class="fixed-top">
    ...
    <div id="container" class="row-fluid">
        ...
        <div id="sidebar" class="nav-collapse collapse">
            ...
            include("menu.php");
            ?>
            <script src="js/empresa.js" charset="utf-8"></script>
            <!-- END SIDEBAR MENU -->
        </div>
        <!-- END SIDEBAR -->
        <!-- BEGIN PAGE -->
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span6 sortable">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>Cadastrar Empresa</h4>
                                <span class="tools">
                            ...
                            <div class="widget-body">
                                <!-- BEGIN FORM-->
                                <form action="#" class="form-horizontal" name="frmempresa" id="frmempresa"
                                    method="post">
                                    <div class="control-group">
                                        <label class="control-label">Nome da Empresa</label>
                                        <div class="controls">
                                            <input type="text" class="input-large" name="nome" id="nome" style="width: 80%;"/>
                                            <span class="help-inline" style="color: red;">*</span>
                                        </div>
                                        <label class="control-label">Endereco</label>
                                        <div class="controls">
                                            <input type="text" class="input-large" name="endereco" id="endereco" style="width: 80%;"/>
                                            <span class="help-inline"></span>
                                        </div>
                                        <label class="control-label">E-mail</label>
                                        <div class="controls">
                                            <input type="email" class="input-large" name="email" id="email" style="width: 80%;"/>
                                            <span class="help-inline"></span>
                                        </div>
                                        <label class="control-label">Telefone</label>
                                        <div class="controls">
                                            <input type="text" class="input-large" name="telefone" id="telefone" style="width: 30%;" data-mask="(99) 99999-9999"/>
                                            <span class="help-inline"></span>
                                        </div>
                                        <label class="control-label">Logomarca</label>
                                        <div class="controls">
                                            <input type="file" class="input-large" name="logo" id="logo" style="width: 30%; margin-left: -15px;"/>
                                            <span class="help-inline"></span>
                                        </div>
                                        <label class="control-label">QR-Code</label>
                                        <div class="controls">
                                            <input type="file" class="input-large" name="qrcode" id="qrcode" style="width: 30%;"/>
                                            <span class="help-inline"></span>
                                        </div>
                                    </div>
                    ...
                    <div class="span6">
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-user"></i>Empresa Cadastrada</h4>
                            </div>
                            <div class="widget-body">
                                ...
                                <div id="lista"></div>
                                <div id="dvlogo" style="text-align: center;"></div>
                                <div id="dvqrcode" style="text-align: center;"></div>
