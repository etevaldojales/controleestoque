...
<body class="fixed-top">
    ...
    <div id="container" class="row-fluid">
        ...
        <div id="sidebar" class="nav-collapse collapse">
            ...
            include("menu.php");
            ?>
            <script src="js/categoria.js" charset="utf-8"></script>
            <!-- END SIDEBAR MENU -->
        </div>
        <!-- END SIDEBAR -->
        <!-- BEGIN PAGE -->
            ...
            <div class="container-fluid">
                ...
                <div class="row-fluid">
                    <div class="span6 sortable">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>Cadastrar nova Categoria</h4>
                                <span class="tools">
                            ...
                            <div class="widget-body">
                                <!-- BEGIN FORM-->
                                <form action="#" class="form-horizontal" name="frmCategoria" id="frmCategoria"
                                    method="post">
                                    <div class="control-group">
                                        <label class="control-label">Nome da Categoria</label>
                                        <div class="controls">
                                            <input type="text" class="input-large" name="categoria" id="categoria" />
                    ...
                    <div class="span6">
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-user"></i>Categorias Cadastradas</h4>
                            </div>
                            <div class="widget-body">
