...
<table width="100%" cellpadding="2" cellspacing="2" background="0">
	<tr bgcolor="#CCCCCC">
    	<td width="30%" align="center" style="line-height: 25px; font-size: 14px;"><b>Nome</b></td>
    	<td width="10%" align="center" style="line-height: 25px; font-size: 14px;"><b>Entrada</b></td>
        <td width="40%" align="center" style="line-height: 25px; font-size: 14px;"><b><nobr>Parcelas - Valor</nobr></b></td>
      	<td width="11%" align="center" style="line-height: 25px; font-size: 14px;"><b><nobr>Valor a Pagar</nobr></b></td>
    	<td width="9%" align="center" style="line-height: 25px; font-size: 14px;"><b>Telefone</b></td>
        <!--
	...
	<tr>
		<td colspan="7" align="center"><b>NÃO HÁ PARCELA VENCIDA NO PERÍODO INFORMADO</b></td>
	</tr>
	<?	
	}
	?>
