...
<body class="fixed-top">
                ...
                <div class="span6">
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            ...
                            <button type="button" class="btn btn-success" onClick="pesquisarParcVenc()">PESQUISAR</button>
                            <!-- END FORM-->
                        </div>
                    </div>
                </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                        ...
                        <div class="widget-body" id="lista_parc_venc">
                        </div>                        
                    </div>
                </div>
			</div>
   ...
   <form name="frm" id="frm" action="impressao_parcvenc.php" target="impressao" method="post">
