...
$hoje		= date("Y/m/d"); 
$dados 		= $_class->get($id);
$ret = $_class->movimentaCredito($id,$valor,$saldo,$hoje,1);
$mensagem  = $_SESSION["nome_usuario"]." -  RECEBEU CREDITO NO VALOR DE: ".number_format($valor,2,",",".").", FORMA DE PAGAMENTO: DINHEIRO, CLIENTE: ".$dados['nome'];		
