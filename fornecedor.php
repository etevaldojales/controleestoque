...
<body class="fixed-top">
    ...
    <div id="container" class="row-fluid">
        ...
        <div id="sidebar" class="nav-collapse collapse">
            ...
            include("menu.php");
            ?>
            <script src="js/fornecedor.js" charset="utf-8"></script>
            <!-- END SIDEBAR MENU -->
        </div>
        <!-- END SIDEBAR -->
        <!-- BEGIN PAGE -->
                    ...
                    <div class="span6 sortable">
                        ...
                        <div class="widget">
                            <div class="widget-title">
                                <h4><i class="icon-reorder"></i>Cadastrar novo Fornecedor</h4>
                                <span class="tools">
                            ...
                            <div class="widget-body">
                                <!-- BEGIN FORM-->
                                <form action="#" class="form-horizontal" name="frmFornecedor" id="frmFornecedor"
                                    method="post">
                                    <div class="control-group">
                                        <label class="control-label">Nome do Fornecedor</label>
                                        <div class="controls">
                                            <input type="text" class="input-large" name="fornecedor" id="fornecedor" />
