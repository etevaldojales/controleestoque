...
<body class="fixed-top">
   ...
   <div id="container" class="row-fluid">
                ...
                <div class="span12">
                    <div class="widget">
                        ...
                        <div class="widget-body form">
                            ...
                            <button type="button" class="btn btn-success" onClick="pesquisarBaixas()">PESQUISAR</button>
                            <!-- END FORM-->
                        </div>
                    </div>
                </div>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="widget">
                        ...
                        <div class="widget-body" id="lista_baixas">
                        </div>                        
                    </div>
                </div>
			</div>
    ...
    <form name="frm" id="frm" action="impressao_baixa.php" target="impressao" method="post">
