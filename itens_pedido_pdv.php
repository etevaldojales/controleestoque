            ...
            if (is_array($itens)) {
                ...
                foreach ($itens as $i) {
                    ...
                    <tr>
                        ...
                        <td class="lntable" style="text-align: center">
                            <a href="javascript: void(0)" onClick="excluirItemPdv(<?= $i['id'] ?>)"
                                style="border: none; background-color: transparent; color: #ff0000; text-align: center;">
                ...
                <tr>
                    <td colspan="5">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="checkbox" name="chk_multiplas" id="chk_multiplas"
                            onChange="toggleMultiplasFpg(this.checked)"> <span class="sp-formpag"><b>Múltiplas
                                Formas</b></span>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                    <td colspan="12">
                        <div id="div_multiplas"
                            style="display: none; margin-top: 15px; border: 1px solid #ccc; padding: 15px; border-radius: 8px; background-color: #fafafa;">
                            <div class="row-fluid">
                                <div class="span4">
                                    <label><b>Dinheiro (R$)</b></label>
                                    <input type="text" class="span12 input_valor_fpg" name="val_dinheiro" id="val_dinheiro"
                                        value="0,00" onKeyup="calcularTrocoMultiplas()" onclick="this.value = ''">
                                </div>
                                <div class="span4">
                                    <label><b>Cartão (R$)</b></label>
                                    <input type="text" class="span12 input_valor_fpg" name="val_cartao" id="val_cartao"
                                        value="0,00" onKeyup="calcularTrocoMultiplas()" onclick="this.value = ''">
                                </div>
                                <div class="span4">
                                    <label><b>Pix (R$)</b></label>
                                    <input type="text" class="span12 input_valor_fpg" name="val_pix" id="val_pix"
                                        value="0,00" onKeyup="calcularTrocoMultiplas()" onclick="this.value = ''">
                                </div>
                            </div>
                            <div class="row-fluid" style="margin-top: 10px; font-size: 13px;">
                                <div class="span4" style="color: #6c757d;">
                                    Total do Pedido: <span style="font-weight: bold; color: #333;" id="disp_total_pedido">R$
                                        <?= number_format($total, 2, ",", ".") ?></span>
                                </div>
                                <div class="span4" style="color: #6c757d;">
                                    Total Pago: <span style="font-weight: bold; color: #333;" id="disp_total_pago">R$
                                        0,00</span>
                                </div>
                                <div class="span4" id="disp_troco_container" style="color: #6c757d;">
                                    Falta Pagar: <span style="font-weight: bold; color: #d9534f;" id="disp_diferenca">R$
                                        <?= number_format($total, 2, ",", ".") ?></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <td colspan="9">
                        <div class="row-fluid text-center" style="margin-top: 20px;">
                            <a class="btn btn-success btn-large hidden-print" href="javascript: void(0)"
                                ...
                                onClick="concluirPedidoPdv(<?= $idpedido ?>, <?= $total ?>, <?= $total_custo ?>, <?= $total_venda ?>)">Finalizar
                                Venda</a>
                        </div>
                    </td>
                    <input type="hidden" name="data" id="data" value="<?= date("Y-m-d") ?>" />
                    <input type="hidden" name="obs" id="obs" </tr>
                        <?php
            } else {
                ?>            <tr>
